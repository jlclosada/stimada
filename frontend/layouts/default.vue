      ...
      <nav class="flex-1 py-4 px-3 space-y-0.5 overflow-auto">
        ...
        >
          ...
          <svg class="w-[18px] h-[18px] flex-shrink-0" :class="isActive(item.href) ? 'text-gold' : 'text-muted group-hover:text-ink'" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <path v-else-if="item.icon === 'tag'" stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3z" />
